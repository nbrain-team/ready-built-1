...
import SocialMediaAutomatorPage from './SocialMediaAutomatorPage';
...
const agents: Agent[] = [
  ...
  {
    id: 'social-media-automator',
    name: 'Social Media Automator',
    description: 'Process videos into clips and auto-generate social media campaigns with AI-powered captions.',
    component: <SocialMediaAutomatorPage />,
  },
  {
    id: 'pr-outreach',
