...
export const TemplateAgentsPopup = () => {
  return (
    <Box style={popupBoxStyle}>
      <Flex direction="column" gap="1">
        ...
        <PopupItem>Weekly Performance Report</PopupItem>
        <PopupItem>Traffic Analysis</PopupItem>
        <PopupItem>Conversion Funnel Analysis</PopupItem>
        <PopupItem>Campaign Summary</PopupItem>
        <PopupItem>Competitor Analysis</PopupItem>
      </Flex>
    </Box>
  );
}; 