...
def verify_token(token: str):
    """Verify token and return payload for WebSocket authentication."""
...
def get_current_active_user(
    ...
    try:
        ...
        logger.error(f"Database error in get_current_active_user: {e}")
        ...
        # For other errors, re-raise the credentials exception
        raise credentials_exception 